// Package docs Code generated by swaggo/swag at 2025-04-28 16:37:53.144961 -0400 EDT m=+1.596418168. DO NOT EDIT
package docs
...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/subscriptions/event/{eventID}/subscribe": {
            "delete": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/subscriptions/event/{eventID}/subscribe/all": {
            "delete": {
                "security": [
                    {
                        "BearerAuth": []
