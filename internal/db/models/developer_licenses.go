...
var DeveloperLicenseWhere = struct {
	...
	LicenseAddress: whereHelper__byte{field: "\"developer_licenses\".\"license_address\""},
	DeveloperID:    whereHelperstring{field: "\"developer_licenses\".\"developer_id\""},
	Status:         whereHelperstring{field: "\"developer_licenses\".\"status\""},
	CreatedAt:      whereHelpertime_Time{field: "\"developer_licenses\".\"created_at\""},
	UpdatedAt:      whereHelpertime_Time{field: "\"developer_licenses\".\"updated_at\""},
}
...
func (o *DeveloperLicense) GetDeveloperLicenseAddressEventVehicles() EventVehicleSlice {
	if o == nil {
		return nil
	}

	return o.R.GetDeveloperLicenseAddressEventVehicles()
}
...
func (o *DeveloperLicense) GetDeveloperLicenseAddressEvents() EventSlice {
	if o == nil {
		return nil
	}

	return o.R.GetDeveloperLicenseAddressEvents()
}
...
func (o *DeveloperLicense) DeveloperLicenseAddressEventVehicles(mods ...qm.QueryMod) eventVehicleQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"event_vehicles\".\"developer_license_address\"=?", o.LicenseAddress),
	)
...
func (o *DeveloperLicense) DeveloperLicenseAddressEvents(mods ...qm.QueryMod) eventQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"events\".\"developer_license_address\"=?", o.LicenseAddress),
	)
...
func (developerLicenseL) LoadDeveloperLicenseAddressEventVehicles(ctx context.Context, e boil.ContextExecutor, singular bool, maybeDeveloperLicense interface{}, mods queries.Applicator) error {
	...
	if singular {
		...
		args[object.LicenseAddress] = struct{}{}
	} else {
		for _, obj := range slice {
			if obj.R == nil {
				obj.R = &developerLicenseR{}
			}
			args[obj.LicenseAddress] = struct{}{}
		}
	}
	...
	query := NewQuery(
		...
		qm.WhereIn(`event_vehicles.developer_license_address in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (developerLicenseL) LoadDeveloperLicenseAddressEvents(ctx context.Context, e boil.ContextExecutor, singular bool, maybeDeveloperLicense interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.From(`events`),
		qm.WhereIn(`events.developer_license_address in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func DeveloperLicenses(mods ...qm.QueryMod) developerLicenseQuery {
	mods = append(mods, qm.From("\"developer_licenses\""))
	q := NewQuery(mods...)
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"\"developer_licenses\".*"})
	}
...
func FindDeveloperLicense(ctx context.Context, exec boil.ContextExecutor, licenseAddress []byte, selectCols ...string) (*DeveloperLicense, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"developer_licenses\" where \"license_address\"=$1", sel,
	)
...
func (o *DeveloperLicense) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if !cached {
		...
		if len(wl) != 0 {
			cache.query = fmt.Sprintf("INSERT INTO \"developer_licenses\" (\"%s\") %%sVALUES (%s)%%s", strings.Join(wl, "\",\""), strmangle.Placeholders(dialect.UseIndexPlaceholders, len(wl), 1, 1))
		} else {
			cache.query = "INSERT INTO \"developer_licenses\" %sDEFAULT VALUES%s"
		}
...
func (o *DeveloperLicense) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		cache.query = fmt.Sprintf("UPDATE \"developer_licenses\" SET %s WHERE %s",
...
func (o DeveloperLicenseSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	sql := fmt.Sprintf("UPDATE \"developer_licenses\" SET %s WHERE %s",
...
func (o *DeveloperLicense) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns, opts ...UpsertOptionFunc) error {
	...
	if !cached {
		...
		cache.query = buildUpsertQueryPostgres(dialect, "\"developer_licenses\"", updateOnConflict, ret, update, conflict, insert, opts...)
...
func (o *DeveloperLicense) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"developer_licenses\" WHERE \"license_address\"=$1"
...
func (o DeveloperLicenseSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"developer_licenses\" WHERE " +
...
func (o *DeveloperLicenseSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	sql := "SELECT \"developer_licenses\".* FROM \"developer_licenses\" WHERE " +
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 1, developerLicensePrimaryKeyColumns, len(*o))
...
func DeveloperLicenseExists(ctx context.Context, exec boil.ContextExecutor, licenseAddress []byte) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"developer_licenses\" where \"license_address\"=$1 limit 1)"
