...
var EventWhere = struct {
	...
	Service:                 whereHelperstring{field: "\"events\".\"service\""},
	Data:                    whereHelperstring{field: "\"events\".\"data\""},
	Trigger:                 whereHelperstring{field: "\"events\".\"trigger\""},
	Setup:                   whereHelperstring{field: "\"events\".\"setup\""},
	TargetURI:               whereHelperstring{field: "\"events\".\"target_uri\""},
	CooldownPeriod:          whereHelperint{field: "\"events\".\"cooldown_period\""},
	DeveloperLicenseAddress: whereHelper__byte{field: "\"events\".\"developer_license_address\""},
	CreatedAt:               whereHelpertime_Time{field: "\"events\".\"created_at\""},
	UpdatedAt:               whereHelpertime_Time{field: "\"events\".\"updated_at\""},
	Status:                  whereHelperstring{field: "\"events\".\"status\""},
	Description:             whereHelpernull_String{field: "\"events\".\"description\""},
	FailureCount:            whereHelperint{field: "\"events\".\"failure_count\""},
}
...
func (o *Event) GetDeveloperLicenseAddressDeveloperLicense() *DeveloperLicense {
	if o == nil {
		return nil
	}
...
func (r *eventR) GetDeveloperLicenseAddressDeveloperLicense() *DeveloperLicense {
	if r == nil {
		return nil
	}
...
func (o *Event) DeveloperLicenseAddressDeveloperLicense(mods ...qm.QueryMod) developerLicenseQuery {
...
func (o *Event) EventLogs(mods ...qm.QueryMod) eventLogQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"event_logs\".\"event_id\"=?", o.ID),
	)
...
func (o *Event) EventVehicles(mods ...qm.QueryMod) eventVehicleQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"event_vehicles\".\"event_id\"=?", o.ID),
	)
...
func (eventL) LoadDeveloperLicenseAddressDeveloperLicense(ctx context.Context, e boil.ContextExecutor, singular bool, maybeEvent interface{}, mods queries.Applicator) error {
	var slice []*Event
	var object *Event
	...
	if singular {
		...
		foreign.R.DeveloperLicenseAddressEvents = append(foreign.R.DeveloperLicenseAddressEvents, object)
		return nil
	}
	...
	for _, local := range slice {
		for _, foreign := range resultSlice {
			if queries.Equal(local.DeveloperLicenseAddress, foreign.LicenseAddress) {
				...
				foreign.R.DeveloperLicenseAddressEvents = append(foreign.R.DeveloperLicenseAddressEvents, local)
				break
			}
		}
	}
...
func (eventL) LoadEventLogs(ctx context.Context, e boil.ContextExecutor, singular bool, maybeEvent interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.From(`event_logs`),
		qm.WhereIn(`event_logs.event_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (eventL) LoadEventVehicles(ctx context.Context, e boil.ContextExecutor, singular bool, maybeEvent interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.From(`event_vehicles`),
		qm.WhereIn(`event_vehicles.event_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// SetDeveloperLicenseAddressDeveloperLicense of the event to the related item.
// Sets o.R.DeveloperLicenseAddressDeveloperLicense to related.
// Adds o to related.R.DeveloperLicenseAddressEvents.
func (o *Event) SetDeveloperLicenseAddressDeveloperLicense(ctx context.Context, exec boil.ContextExecutor, insert bool, related *DeveloperLicense) error {
	var err error
	if insert {
	...
	values := []interface{}{related.LicenseAddress, o.ID}
	...
	if related.R == nil {
		related.R = &developerLicenseR{
			DeveloperLicenseAddressEvents: EventSlice{o},
		}
	} else {
		related.R.DeveloperLicenseAddressEvents = append(related.R.DeveloperLicenseAddressEvents, o)
	}
...
func (o *Event) AddEventVehicles(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*EventVehicle) error {
	...
	for _, rel := range related {
		if insert {
			...
			values := []interface{}{o.ID, rel.VehicleTokenID, rel.EventID, rel.DeveloperLicenseAddress}
